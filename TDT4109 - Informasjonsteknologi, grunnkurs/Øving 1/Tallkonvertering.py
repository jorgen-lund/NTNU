...
prog_alder = input("Hvor gammel var du da du begynte å programmere? ")
prog_lengde = int(alder) - int(prog_alder)
print("Da har du programmert i", prog_lengde, "år.")
input("Syns du de " + str(prog_lengde) + " årene har vært givende? ")
...
print("Vennligst skriv et flyttall med minst 5 siffer både før og etter .")
flyttall = float(input("Hva er tallet ditt? "))
print("Konvertert til et heltall med int():", int(flyttall))
print("Avrundet til nærmeste heltall:", round(flyttall))
print("Avrundet til to desimaler:", round(flyttall, 2))
print("Avrundet til fire desimaler:", round(flyttall, 4))
print("Avrundet til nærmeste tusen:", round(flyttall, -3))
...
ønskede_desimaler = int(input("Hvor mange desimaler er ønskelig? "))
print("Tallet du skrev er", flyttall, "og med", ønskede_desimaler, "desimaler blir det til", round(flyttall, ønskede_desimaler))
