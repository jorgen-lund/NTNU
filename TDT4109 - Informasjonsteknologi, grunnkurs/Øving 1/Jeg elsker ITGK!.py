...
#Bruker print funksjonen, åpen parentes i linje 2, skiller mellom skrift og tall med komma, bruker punktum i desimaltall.
print("Norge")
print()
...
#Brukte enkle fnutter, pga doble rundt utsagnet.
#print("Hei')
...
- Var'e slanger som laget det? - Nei, Guido van Rossum.
- Likte slanger kanskje da? - Nei, digga "Monthy Python"
- Hva er det? Et fjell?
- Nei, engelsk komigruppe. Begynte i '69
- Wow! Var'e fremdeles dinosaurer da?""")
...
#Dette er nå en kommentar. Mangler ikke #.
