...
print(input("Hva er ditt favorittfag? "), "- interessant!")
...
omkrets_sirkel = (math.tau * r)
print("Omkrets av sirkelen:", round(omkrets_sirkel, 1))  #tau er det samme som 2 pi
areal_sirkel = (math.pi * r**2)
print("Areal av sirkelen:", round(a_sirkel, 1))
areal_sylinder = (omkrets_sirkel * h + 2 * areal_sirkel)
