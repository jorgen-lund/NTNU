...
gram_stoff = float(input("Hvor mange gram " + stoff + " har du? "))
ant_mol = gram_stoff / molvekt * 6.022e23
print("Du har ", format(ant_mol, ".2e"), "molekyler", stoff)
...
antall_hørt = int(input("Antall ulike 10-toners melodilinjer du har hørt? "))
print("Du har hørt", format(antall_hørt / 8.25e19, ".2e"), "prosent av melodier som er mulig.")
