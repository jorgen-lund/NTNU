...
def add_family_member(rolle, navn):
    ...
    if rolle in my_family:
        fam_liste.append(my_family[rolle])
        print(fam_liste)
        fam_liste.append(navn)
        my_family[rolle] = fam_liste
    else:
        my_family[rolle] = navn
    return my_family
...
add_family_member("søster", "Gunnvår")
add_family_member("far", "Trondulf")
add_family_member("søster", "Olga")
print (my_family)
