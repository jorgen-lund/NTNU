...
#endre koden under
antall = int(input("Hvor mange repetisjoner ønskes? "))
for i in range(antall):
...
adj = input("Beskriv deg selv med et adjektiv")
while adj != "":
    print("Hah, du", adj + "!? Jeg er mye", adj + "ere!") # Skjønner ikke hvordan jeg skal stoppe infinity loopen.
    adj = input("Beskriv deg selv med et adjektiv. ")
print("Takk for nå!") 
#Oppgave c er gjort i oppgave d under intro.
...
while i > 0:    #Hvordan får jeg dette til å stanse ord større enn den siste mulige?
    adj = input("Beskriv deg selv med et adjektiv? ")
    print("Hah, du", adj + "!? Jeg er mye", adj + "ere!")
    i = i - len(adj)
    print("Du har ", i, "bokstaver til disposisjon")
...
print("Tallene 1 - 5 printet ut ved en for-løkke: ")
