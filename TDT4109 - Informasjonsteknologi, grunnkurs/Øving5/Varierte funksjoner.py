...
print("Absoluttverdien til -50 er", absol(-50))
...
def knop2km_t(hastighet_knop):
    return(hastighet_knop * 0.514444444) * 3.6
...
#def imp2cm(antall_fot, antall_tommer):
    #totalt = antall_fot * 12
    #return( 
def imp2cm():
    fot = float(input("Oppgi antall fot: "))
    tommer = float(input("oppgi antall tommer: "))
    
    fot_til_cm = fot * 30.48
    print("Din høyde i fot er ", fot_til_cm, "cm." )
    
    tommer_til_cm = tommer * 2.54
    print("Din høyde i tommer er ", tommer_til_cm, "cm")
    print("Og tilsammen er du, ", tommer_til_cm + fot_til_cm, "cm høy.")
