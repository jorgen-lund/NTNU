...
meter = int(input("Hvor mange meter? "))
...
# Hadde det ikke funket å bare lage en lokal variabel inne i funksjonen (gravity = 9.81), fremfor å gå igjennom alt dette ekstra bare for å bruke en global variabel?
