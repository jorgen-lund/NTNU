...
def hello(streng):
    streng = streng[0::4]
    return streng
print(hello("Sjallabais per galakse"))
...
# **Ditt svar:** Den midtereste er korrekt. Den vil printe ut cake. -4:100 betyr at den starter fra -4 plasser til høyre, og går opp til 100 mot høyre.
# 
# Kodesnutt 1 er feil da man prøver å fortelle Python at I want cake fra plass 7 av og til høyre skal være lik cupcake. Man kan ikke slice en variabel og deretter tilegne den en string.
# 
# Kodesnutt 3 er feil da man sier at streng er når en tom liste. 
