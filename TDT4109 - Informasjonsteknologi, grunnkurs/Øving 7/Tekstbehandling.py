...
liste = s.split()           #Vil bruke standard-skilletegnet som er mellomrom
print(liste)
...
print(changeString("  Hallo Alle Sammen  "))
...
def splitStreng(streng, karakter = ""):
    splittet = streng.split(karakter)
    return splittet

print(splitStreng("Hakuna Matata", karakter = "t"))
...
# **Svar:** Fordi i funksjon func, så sammenligner den s1 med s2.lower, altså så sammenligner den med hele s2 stringen non-caps. Da blir Eat gjort om til eat, og dermed er s1 i s2, og if statementen er sann, og s = "The more you weigh..."
#    
